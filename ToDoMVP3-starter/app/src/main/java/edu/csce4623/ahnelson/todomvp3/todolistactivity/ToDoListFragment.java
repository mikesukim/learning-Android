...
//        Toast.makeText(getContext(),"To Be Implemented!",Toast.LENGTH_SHORT).show();
        ...
        Intent myIntent = new Intent(getContext(), ToDoAddEditActivity.class);
        myIntent.putExtra("ToDoItem", item);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(data.hasExtra("ToDoItem")) {
            if(data.hasExtra("Deletion")) {
                mPresenter.result(requestCode, resultCode, (ToDoItem) data.getSerializableExtra("ToDoItem"), true);
            } else
                mPresenter.result(requestCode, resultCode, (ToDoItem) data.getSerializableExtra("ToDoItem"), false);
    ...
    private static class ToDoItemsAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            CheckBox completionTV = (CheckBox) rowView.findViewById(R.id.etItemCompletion);
            completionTV.setChecked(toDoItem.getCompleted());
